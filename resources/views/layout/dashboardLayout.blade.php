...
<body>
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo fw-bold fs-2" href="{{ route('dashboard') }}">AsisQuick</a>
    ...
    <footer>
        <p class="text-center "> <span class="text-primary fs-5">&copy;</span> 2023-2024 Albert Ospina todos los derechos reservados
        </p>
    </footer>
