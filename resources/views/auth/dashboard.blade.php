            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title fs-2">BIENVENID@ {{ Auth::user()->name }}, ES UN GUSTO TENERTE DE VUELTA 😁😄</h4>
                        <p>AsisQuick es un sistema creado para ayudar con los diferentes procesos en las aulas de clase y equipos de la institución; cuyo objetivo es que todo proceso sea atendido y resuelto lo más pronto
                            posible.</p>
                        <div class="row">
